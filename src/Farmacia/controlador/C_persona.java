...
public class C_persona {
 public static Vista_Persona vistapersona;
    ...
    public C_persona(Vista_Persona vistapersona) {
        this.vistapersona = vistapersona;
        vistapersona.setVisible(true);
    lista();
            
        vistapersona.getBtn_subirF().addActionListener(x -> obtieneImagen());
    ...
    public void guardar() {
        ...
        bdpersona.setTelefono(vistapersona.getTxt_telefono().getText());
        //bdpersona.setCorreo(vistapersona.getTxtcorreo().getText());

        ImageIcon ic = (ImageIcon) vistapersona.getBtn_cargar().getIcon();
    ...
    private void obtieneImagen() {
        vistapersona.getBtn_cargar().setIcon(null);
        JFileChooser j = new JFileChooser();
        j.setFileSelectionMode(JFileChooser.FILES_ONLY);
        int estado = j.showOpenDialog(null);
        if (estado == JFileChooser.APPROVE_OPTION) {
            try {
                Image icono = ImageIO.read(j.getSelectedFile()).getScaledInstance(vistapersona.getBtn_cargar().getWidth(), vistapersona.getBtn_cargar().getHeight(), Image.SCALE_DEFAULT);
                vistapersona.getBtn_cargar().setIcon(new ImageIcon(icono));
                vistapersona.getBtn_cargar().updateUI();
    ...
    public void seleccionar() {
        ...
        List<Persona_MD> lista = bdpersona.obtenerdatos(cedula);
        ...
        vistapersona.getTxt_telefono().setText(bdpersona.getTelefono());
       bdpersona.setCorreo(lista.get(0).getCorreo());
        ...
        if (img != null) {
            Image newimg = img.getScaledInstance(vistapersona.getBtn_cargar().getWidth(), vistapersona.getBtn_cargar().getHeight(), java.awt.Image.SCALE_SMOOTH);
            ImageIcon icon = new ImageIcon(newimg);
            vistapersona.getBtn_cargar().setIcon(icon);
        } else {
            vistapersona.getBtn_cargar().setIcon(null);
        }
    ...
    public void nuevo() {
        ...
        vistapersona.getTxt_telefono().setText("");
        
        vistapersona.getBtn_cargar().setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/usuario.png")));
