...
//                    BufferedImage bi=Base64.decode( ImageIO.read(is));
    ...
    public boolean insertar() {
        ...
        String nsql = "INSERT INTO persona (cedula,nombres,apellidos,direccion,correo,telefono,fecha_nacimiento,estado,foto)" + "VALUES ('" + getCedula() + "','" + getNombres() + "','" + getApellidos() + "','" + getFecha_nacimiento() + "','" + getDireccion() + "','" + getCorreo() + "','" + getTelefono() + "','" + ef + "','" + getEstado()+ "')";
    ...
    public boolean Modificar(String codigo) {
        ...
        String nsql = "UPDATE persona set \"nombres\"='" + getNombres() + "',\"apellidos\"='" + getApellidos() + "',\"direccion\"='" + getDireccion() + "',\"correo\"='" + getCorreo() + "',\"telefono\"='" + getTelefono() + "',\"fecha_nacimiento\"='" + getFecha_nacimiento() + "',\"estado\"='" + getEstado()+ "',\"foto\"='" + ef + "'"
                + " where \"cedula\"='" + codigo + "'";
