...
public class Persona_BD extends Persona_MD {
    ...
    public Persona_BD(String cedula, String nombre, String direccion, String fecha_nacimiento, String ciudad, String celular, Image foto) {
    ...
    public List<Persona_MD> mostrardatos() {
        try {
            List<Persona_MD> listausuario = new ArrayList<Persona_MD>();
            String sql = "select * from persona";
            ResultSet rs = conecta.query(sql);
            while (rs.next()) {
                Persona_MD u = new Persona_MD();
