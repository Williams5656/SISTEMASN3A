...
public class Vproveedores extends javax.swing.JFrame {
    ...
    public JTextField getTxtrepresentanteleg() {
        return txtrepresentanteleg;
    }

    public void setTxtrepresentanteleg(JTextField txtrepresentanteleg) {
        this.txtrepresentanteleg = txtrepresentanteleg;
    }
    ...
    public void setTxtdescripcion(JTextField txtdescripcion) {
        this.txtnombrecom = txtdescripcion;
    }
    ...
    public void setTxtmarca(JTextField txtmarca) {
        this.txtrepresentanteleg = txtmarca;
    }
    ...
    private void initComponents() {
        ...
        txtrepresentanteleg = new javax.swing.JTextField();
        ...
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, -1));
        ...
        getContentPane().add(txtruc, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 130, 20));
        ...
        getContentPane().add(txtnombrecom, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 130, 20));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel11.setText("Celular:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 60, -1, -1));
        ...
        getContentPane().add(txtcelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 60, 130, 20));
        ...
        txtrepresentanteleg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtrepresentantelegActionPerformed(evt);
            }
        });
        getContentPane().add(txtrepresentanteleg, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 130, 130, 20));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel13.setText("Buscar");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 200, -1, -1));
        ...
        getContentPane().add(txtbuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 200, 130, 20));
        ...
        getContentPane().add(buttonbuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 50, 30));
        ...
        getContentPane().add(buttonnuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 240, 40, 40));
        ...
        getContentPane().add(buttonguardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, 40, -1));
        ...
        getContentPane().add(buttonmodificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 240, 50, 40));
        ...
        getContentPane().add(buttoneliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, 40, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 660, 320));
        ...
        getContentPane().add(buttonimprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 570, 30, 40));
        ...
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 810, 630));
    ...
    private void txtrepresentantelegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtrepresentantelegActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtrepresentantelegActionPerformed
    ...
    private javax.swing.JTextField txtrepresentanteleg;
