...
//                u.setDiscapacidad(rs.getString("email"));
//
//                listau.add(u);
//            }
//            rs.close();
...
//
//        String sql = "INSERT INTO clientes(codigo, cedula, nombres, apellidos, celular, direccion, email) VALUES ('" + getCodigo() + "','" + getCedula() + "','" + getNombres()+ "','" + getApellidos()+ "','" + getCelular()+ "','" + getEstado()+ "','" + getDiscapacidad()+ "')";
//
...
//
//        String sql = "update clientes set \"cedula\"='" + getCedula()+ "',\"nombres\"='" + getNombres()+ "',\"apellidos\"='" + getApellidos()+ "',\"celular\"='" + getCelular()+ "',\"direccion\"='" + getEstado()+ "',\"email\"='" + getDiscapacidad()+ "'"
//                + " where \"codigo\"='" + codigo + "'";
//
//        if (conectar.noQuery(sql) == null) {
//            return true;
